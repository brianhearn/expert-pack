...
`ontology.schema.yaml` defines `ontology.yaml`, the maintainer-approved ontology registry for a pack. Suggestions generated by `ep-ontology-suggest.py` are not authoritative until accepted into this file.
